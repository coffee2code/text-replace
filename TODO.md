...
* Prevent replacements from affecting shortcode tags. Perhaps control behavior via filter and (advanced) setting. See unit test `test_does_not_replace_within_shortcodes()`.
